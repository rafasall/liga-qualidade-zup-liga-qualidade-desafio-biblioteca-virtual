...
import br.com.zup.edu.ligaqualidade.desafiobiblioteca.modifique.service.BibliotecaService;
...
public class Solucao {
	...
	public static Set<EmprestimoConcedido> executa(
		...
		return BibliotecaService.processar(livros, exemplares, usuarios, emprestimos, devolucoes, dataExpiracao);
	}
